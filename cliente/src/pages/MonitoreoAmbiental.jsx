...
import { getDatosAmbientales } from '../api/monitoreo.api'; // ajusta la ruta según tu estructura
 ...
 export function MonitoreoAmbiental () {
  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold mb-6 text-center text-green-800">Monitoreo Ambiental</h1>
      {datos.length > 0 ? (
