...
export function MonitoreoContaminantes() {
  ...
  const descargarCSVContaminantes = async () => {
    if (!ready) {
  ...
  const url =
    `http://127.0.0.1:8000/api/monitoreo/sensadocontaminantes/rango/?${params.toString()}`;
  ...
  try {
    ...
    link.download = "historial_contaminantes.csv";
    link.click();
              ...
              <div className="bg-transparent">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <div className="flex gap-2 ml-4">
                    ...
                    <button onClick={descargarCSVContaminantes} disabled={!ready}
