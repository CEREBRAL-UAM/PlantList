...
export function MonitoreoSuelo () {
  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold mb-6 text-center text-green-800">Monitoreo de Suelo</h1>
