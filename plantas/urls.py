...
router.register(r'plantas_espacios', views.PlantasEspaciosViewSet, 'plantas_espacios')
...
urlpatterns = [
    ...
    path("apiv1/espacios/colaboradores/", views.ColaboradoresEspacio.as_view(), name='colaboradores_espacio'),
